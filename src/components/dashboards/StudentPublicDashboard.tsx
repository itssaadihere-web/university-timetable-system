                              ...
                              <div
                                className={`h-full p-2.5 rounded-xl border shadow-2xs flex flex-col justify-between transition-all duration-150 ${
                                  isUnassigned
                                    ...
                                    : 'bg-white border-slate-200/90 hover:border-shu-700 hover:shadow-md'
                                }`}
                              >
                                <div>
                                  <div className="flex items-center justify-between gap-1 mb-1">
                                    <div className="flex items-center gap-1 flex-wrap">
                                      <span className="font-bold text-shu-700 font-mono text-[11px] bg-red-50 px-1.5 py-0.5 rounded border border-red-100">
                                        {crs?.code}
                                      </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {daySessions.map((session) => {
                ...
                return (
                  <div
                    key={session.id}
                    className={`bg-white rounded-2xl border transition-all p-5 space-y-3 shadow-2xs ${
                      isUnassigned
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-2">
                      <span className="px-2.5 py-1 rounded-lg bg-red-50 text-shu-700 font-bold font-mono text-xs border border-red-200/70">
                        {course?.code || 'CRS-000'}
                      </span>
