...
export const INITIAL_ROOMS: Room[] = [
  { id: 'room-unassigned', name: '⚠️ Room Not Assigned (Pending)', building: 'TBD', floor: 0, capacity: 60, room_types: ['standard'] },
...
export const INITIAL_FACULTY: Faculty[] = [
  { id: 'fac-abid-khan', name: 'Abid Khan', email: 'abid.khan@univ.edu', department: 'Accounting & Finance', max_load_per_day: 4 },
  { id: 'fac-waleed-wasti', name: 'Waleed Wasti', email: 'waleed.wasti@univ.edu', department: 'Economics', max_load_per_day: 4 },
  { id: 'fac-hafiz-shayan', name: 'Hafiz Shayan', email: 'hafiz.shayan@univ.edu', department: 'Islamic Studies', max_load_per_day: 4 },
  { id: 'fac-sumaira-ashraf', name: 'Sumaira Ashraf', email: 'sumaira.ashraf@univ.edu', department: 'Humanities & Islamic', max_load_per_day: 3 },
  { id: 'fac-shamaila-burney', name: 'Shamaila Burney', email: 'shamaila.burney@univ.edu', department: 'Marketing', max_load_per_day: 3 },
  { id: 'fac-musawwir', name: 'Musawwir Ali Soomro', email: 'musawwir@univ.edu', department: 'Mathematics & Statistics', max_load_per_day: 4 },
  { id: 'fac-abdullah-idrees', name: 'Mr Muhammad Abdullah Idrees', email: 'abdullah.idrees@univ.edu', department: 'Finance', max_load_per_day: 4 },
  { id: 'fac-sabeen-amjad', name: 'Sabeen Amjad', email: 'sabeen.amjad@univ.edu', department: 'Communication', max_load_per_day: 4 },
  { id: 'fac-memoona-shahzad', name: 'Memoona Shahzad', email: 'memoona.shahzad@univ.edu', department: 'Social Sciences', max_load_per_day: 4 },
  { id: 'fac-gul-munir', name: 'Gul Munir Deedar Ali', email: 'gul.munir@univ.edu', department: 'Mathematics', max_load_per_day: 4 },
  { id: 'fac-mohammad-omar', name: 'Mohammad Omar', email: 'mohammad.omar@univ.edu', department: 'Business Analytics', max_load_per_day: 4 },
  { id: 'fac-zubair-shah', name: 'Zubair Shah', email: 'zubair.shah@univ.edu', department: 'Pakistan Studies', max_load_per_day: 4 },
  { id: 'fac-misbah-iqbal', name: 'Misbah Iqbal', email: 'misbah.iqbal@univ.edu', department: 'Finance', max_load_per_day: 4 },
  { id: 'fac-rizwan-akram', name: 'Muhammad Rizwan Akram', email: 'rizwan.akram@univ.edu', department: 'Humanities', max_load_per_day: 4 },
  { id: 'fac-ateeque-rahman', name: 'Ateeque Rahman', email: 'ateeque.rahman@univ.edu', department: 'Computer Science', max_load_per_day: 4 },
  { id: 'fac-mariyam-khan', name: 'Mariyam Khan', email: 'mariyam.khan@univ.edu', department: 'Computer Science', max_load_per_day: 4 },
  { id: 'fac-mehak-kanwal', name: 'Mehak Kanwal', email: 'mehak.kanwal@univ.edu', department: 'Pakistan Studies', max_load_per_day: 3 },
  { id: 'fac-sarmad-hassan', name: 'Syed Sarmad Hassan', email: 'sarmad.hassan@univ.edu', department: 'Accounting & Risk', max_load_per_day: 5 },
  { id: 'fac-fakhir-musharraf', name: 'Muhammad Fakhir Musharraf', email: 'fakhir.musharraf@univ.edu', department: 'Actuarial Science & Risk', max_load_per_day: 5 },
  { id: 'fac-qaiser-hussain', name: 'Syed Qaiser Hussain', email: 'qaiser.hussain@univ.edu', department: 'Business Communication', max_load_per_day: 4 },
  { id: 'fac-nayeem-ansari', name: 'Nayeem Ul Hasan Ansari', email: 'nayeem.ansari@univ.edu', department: 'Finance & Markets', max_load_per_day: 4 },
  { id: 'fac-pervaiz-mobin', name: 'Pervaiz Mobin', email: 'pervaiz.mobin@univ.edu', department: 'Management & Projects', max_load_per_day: 5 },
  { id: 'fac-kousar-zaheer', name: 'Kousar Zaheer', email: 'kousar.zaheer@univ.edu', department: 'Management & Marketing', max_load_per_day: 4 },
  { id: 'fac-shah-saleem', name: 'Shah Muhammad Saleem', email: 'shah.saleem@univ.edu', department: 'Management & Marketing', max_load_per_day: 4 },
  { id: 'fac-sana-javed', name: 'Sana Javed', email: 'sana.javed@univ.edu', department: 'Communication', max_load_per_day: 4 },
  { id: 'fac-khalida-khan', name: 'Khalida Khan', email: 'khalida.khan@univ.edu', department: 'Management', max_load_per_day: 4 },
  { id: 'fac-kanwal-munir', name: 'Kanwal Munir', email: 'kanwal.munir@univ.edu', department: 'Social Studies', max_load_per_day: 3 },
  { id: 'fac-ghulam-mustafa', name: 'Ghulam Mustafa', email: 'ghulam.mustafa@univ.edu', department: 'Accounting', max_load_per_day: 4 },
  { id: 'fac-adnan-ali', name: 'Adnan Ali', email: 'adnan.ali@univ.edu', department: 'Accounting & Finance', max_load_per_day: 3 },
  { id: 'fac-shaikh-bilal', name: 'Shaikh Bilal', email: 'shaikh.bilal@univ.edu', department: 'Audit & Accounting', max_load_per_day: 3 },
  { id: 'fac-jibran-sartaj', name: 'Jibran Sartaj', email: 'jibran.sartaj@univ.edu', department: 'Business Law', max_load_per_day: 4 },
  { id: 'fac-yasar-rizwan', name: 'Yasar Rizwan', email: 'yasar.rizwan@univ.edu', department: 'MIS & ERP', max_load_per_day: 4 },
  { id: 'fac-nadeem-hanif', name: 'Muhammad Nadeem Hanif', email: 'nadeem.hanif@univ.edu', department: 'Finance & Regulations', max_load_per_day: 4 },
  { id: 'fac-shariq-waqar', name: 'Shariq Waqar', email: 'shariq.waqar@univ.edu', department: 'Taxation & Accounting', max_load_per_day: 4 },
  { id: 'fac-rehan-butt', name: 'Rehan Muzamil Butt', email: 'rehan.butt@univ.edu', department: 'Entrepreneurship', max_load_per_day: 4 },
  { id: 'fac-quaid-johar', name: 'Quaid Johar', email: 'quaid.johar@univ.edu', department: 'Audit & Assurance', max_load_per_day: 4 },
  { id: 'fac-ekhlaque-ahmed', name: 'Ekhlaque Ahmed', email: 'ekhlaque.ahmed@univ.edu', department: 'Marketing & Strategy', max_load_per_day: 5 },
  { id: 'fac-zuhair-mohsin', name: 'Zuhair Mohsin', email: 'zuhair.mohsin@univ.edu', department: 'Fintech', max_load_per_day: 3 },
  { id: 'fac-khalid-petiwala', name: 'Khalid Petiwala', email: 'khalid.petiwala@univ.edu', department: 'Advanced Taxation', max_load_per_day: 3 },
  { id: 'fac-saman', name: 'Saman', email: 'saman@univ.edu', department: 'Marketing', max_load_per_day: 3 },
  { id: 'fac-priyanka-bajaj', name: 'Priyanka Bajaj', email: 'priyanka.bajaj@univ.edu', department: 'HR & Management', max_load_per_day: 4 },
  { id: 'fac-asif-shamim', name: 'Asif Shamim', email: 'asif.shamim@univ.edu', department: 'Economics', max_load_per_day: 3 },
  { id: 'fac-hunain', name: 'Hunain', email: 'hunain@univ.edu', department: 'Foreign Languages', max_load_per_day: 3 },
  { id: 'fac-zeeshan-ahmed', name: 'Zeeshan Ahmed', email: 'zeeshan.ahmed@univ.edu', department: 'Project Management', max_load_per_day: 3 },
  { id: 'fac-raheel', name: 'Raheel', email: 'raheel@univ.edu', department: 'Supply Chain Management', max_load_per_day: 4 },
  { id: 'fac-hassaan-ahmed', name: 'Hassaan Ahmed', email: 'hassaan.ahmed@univ.edu', department: 'Business Simulations', max_load_per_day: 3 },
  { id: 'fac-faisal-shaikh', name: 'Faisal Shaikh', email: 'faisal.shaikh@univ.edu', department: 'Marketing Research', max_load_per_day: 3 },
  { id: 'fac-fahad-anwar', name: 'Muhammad Fahad Anwar', email: 'fahad.anwar@univ.edu', department: 'SCM Sustainability', max_load_per_day: 3 },
];
...
export const INITIAL_SESSIONS: ClassSession[] = [
  ...
  { id: 'sess-ban4-4b', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-ban202', faculty_id: 'fac-mariyam-khan', room_id: 'room-unassigned', batch_id: 'batch-ban-4', day_of_week: 5, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-ban4-5', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-pst101', faculty_id: 'fac-mehak-kanwal', room_id: 'room-unassigned', batch_id: 'batch-ban-4', day_of_week: 1, start_time: '11:00', end_time: '13:00', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-arm5-1', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-rm301', faculty_id: 'fac-sarmad-hassan', room_id: 'room-unassigned', batch_id: 'batch-arm-5', day_of_week: 1, start_time: '09:00', end_time: '10:30', session_type: 'regular', status: 'published' },
  { id: 'sess-arm5-2', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-rm302', faculty_id: 'fac-fakhir-musharraf', room_id: 'room-unassigned', batch_id: 'batch-arm-5', day_of_week: 1, start_time: '12:00', end_time: '15:00', session_type: 'regular', status: 'published' },
  { id: 'sess-arm5-3', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-rm304', faculty_id: 'fac-sarmad-hassan', room_id: 'room-unassigned', batch_id: 'batch-arm-5', day_of_week: 3, start_time: '09:00', end_time: '10:30', session_type: 'regular', status: 'published' },
  { id: 'sess-arm5-4', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-fin314', faculty_id: 'fac-fakhir-musharraf', room_id: 'room-unassigned', batch_id: 'batch-arm-5', day_of_week: 3, start_time: '12:00', end_time: '15:00', session_type: 'regular', status: 'published' },
  ...
  // ARM-6
  { id: 'sess-arm6-1', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-rm301', faculty_id: 'fac-sarmad-hassan', room_id: 'room-unassigned', batch_id: 'batch-arm-6', day_of_week: 1, start_time: '09:00', end_time: '10:30', session_type: 'regular', status: 'published' },
  { id: 'sess-arm6-2', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-rm302', faculty_id: 'fac-fakhir-musharraf', room_id: 'room-unassigned', batch_id: 'batch-arm-6', day_of_week: 1, start_time: '12:00', end_time: '15:00', session_type: 'regular', status: 'published' },
  { id: 'sess-arm6-3', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-rm304', faculty_id: 'fac-sarmad-hassan', room_id: 'room-unassigned', batch_id: 'batch-arm-6', day_of_week: 3, start_time: '09:00', end_time: '10:30', session_type: 'regular', status: 'published' },
  { id: 'sess-arm6-4', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-fin314', faculty_id: 'fac-fakhir-musharraf', room_id: 'room-unassigned', batch_id: 'batch-arm-6', day_of_week: 3, start_time: '12:00', end_time: '15:00', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-arm6-6', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-fin315', faculty_id: 'fac-waleed-wasti', room_id: 'room-unassigned', batch_id: 'batch-arm-6', day_of_week: 2, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-af3a-4', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-hus202', faculty_id: 'fac-memoona-shahzad', room_id: 'room-unassigned', batch_id: 'batch-bsaf-3a', day_of_week: 2, start_time: '08:30', end_time: '10:30', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-af3b-4', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-hus202', faculty_id: 'fac-memoona-shahzad', room_id: 'room-unassigned', batch_id: 'batch-bsaf-3b', day_of_week: 2, start_time: '13:00', end_time: '15:00', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-af3c-4', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-hus202', faculty_id: 'fac-memoona-shahzad', room_id: 'room-unassigned', batch_id: 'batch-bsaf-3c', day_of_week: 1, start_time: '13:00', end_time: '15:00', session_type: 'regular', status: 'published' },
  { id: 'sess-af3c-5', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-mgt201', faculty_id: 'fac-khalida-khan', room_id: 'room-unassigned', batch_id: 'batch-bsaf-3c', day_of_week: 3, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-af4-2', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-acc203', faculty_id: 'fac-sarmad-hassan', room_id: 'room-unassigned', batch_id: 'batch-bsaf-4', day_of_week: 1, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-af5-1', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-acc210', faculty_id: 'fac-shaikh-bilal', room_id: 'room-unassigned', batch_id: 'batch-bsaf-5', day_of_week: 3, start_time: '12:00', end_time: '15:00', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-af7-2', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-fin409', faculty_id: 'fac-nayeem-ansari', room_id: 'room-unassigned', batch_id: 'batch-bsaf-7', day_of_week: 2, start_time: '12:00', end_time: '15:00', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-bba5-1', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-acc306', faculty_id: 'fac-sarmad-hassan', room_id: 'room-unassigned', batch_id: 'batch-bba-5', day_of_week: 1, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-bba5-3', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-fin306', faculty_id: 'fac-abid-khan', room_id: 'room-unassigned', batch_id: 'batch-bba-5', day_of_week: 2, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-bba5-6', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-mth304', faculty_id: 'fac-mohammad-omar', room_id: 'room-unassigned', batch_id: 'batch-bba-5', day_of_week: 3, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-bba6-4', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-mgt301', faculty_id: 'fac-zeeshan-ahmed', room_id: 'room-unassigned', batch_id: 'batch-bba-6', day_of_week: 4, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-bba6-6', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-mkt413', faculty_id: 'fac-ekhlaque-ahmed', room_id: 'room-unassigned', batch_id: 'batch-bba-6', day_of_week: 3, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  { id: 'sess-bba6-7', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-scm418', faculty_id: 'fac-raheel', room_id: 'room-unassigned', batch_id: 'batch-bba-6', day_of_week: 3, start_time: '12:00', end_time: '15:00', session_type: 'regular', status: 'published' },
  { id: 'sess-bba6-8', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-hrm412', faculty_id: 'fac-pervaiz-mobin', room_id: 'room-unassigned', batch_id: 'batch-bba-6', day_of_week: 3, start_time: '12:00', end_time: '15:00', session_type: 'regular', status: 'published' },
  ...
  { id: 'sess-bba7-5', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-mkt407', faculty_id: 'fac-kousar-zaheer', room_id: 'room-unassigned', batch_id: 'batch-bba-7', day_of_week: 2, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  { id: 'sess-bba7-6', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-scm419', faculty_id: 'fac-fahad-anwar', room_id: 'room-unassigned', batch_id: 'batch-bba-7', day_of_week: 2, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },
  { id: 'sess-bba7-7', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-hrm411', faculty_id: 'fac-priyanka-bajaj', room_id: 'room-unassigned', batch_id: 'batch-bba-7', day_of_week: 5, start_time: '08:30', end_time: '11:30', session_type: 'regular', status: 'published' },

  // BBA - 8 (HUM-401 has NO ROOM PROVIDED -> Alert!)
  { id: 'sess-bba8-1', semester_id: '11111111-1111-1111-1111-111111111111', course_id: 'crs-hum401', faculty_id: 'fac-shah-saleem', room_id: 'room-unassigned', batch_id: 'batch-bba-8', day_of_week: 2, start_time: '12:00', end_time: '15:00', session_type: 'regular', status: 'published' },
